        ...
        view: {
            ...
            blocks : [
                ...
                // build the poll question
                {
                    ...
                    element : {
                        // now actually type out their own value instead of picking from a drop down
                        type: "plain_text_input",
                        action_id: "poll_question"
                    },
                    label: {
                        type: "plain_text",
                        text: "What day do you want to schedule a meeting?",
                        emoji: true
                    }
                },
            ...
            // and, you also have to submit the view. This is the submit button at the bottom
            submit: {
                type: "plain_text",
                text: "Start poll"
            }
...
app.view('poll_shortcut', async ({ack, body, view, client}) => {
    ...
    const {
        ...
        option_4,
        option_5,
    // the data is from the view in the states in the values
    } = view.state.values;
            ...
            blocks: [
                // each block should be its own object
                {
                    ...
                    text: {
                        ...
                        text: `<@${user.id}> wants to schedule a meeting on ${poll_question.poll_question.value}. What time works best?`
                    }
                },
                ...
                },
                {
                    ...
                    text: {
                        type: "plain_text",
                        // those tick marks allow you to get the data into the string while still being a string
                        text: `:four: ${option_4.option_4.value}`,
                        emoji: true
                    }
                },
                {
                    ...
                    text: {
                        type: "plain_text",
                        // those tick marks allow you to get the data into the string while still being a string
                        text: `:five: ${option_5.option_5.value}`,
                        emoji: true
                    }
                },
            ]
